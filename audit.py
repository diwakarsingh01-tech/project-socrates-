...
class ProjectSocratesAuditSuite(unittest.TestCase):
    ...
    def test_assessment_submission_and_analytics(self):
        ...
        # Step 3: Verify dynamic analytics groups it correctly
        ...
        self.assertIn('SIX DAYS', data)
        self.assertEqual(data['SIX DAYS']['pre'], 100.0)
        self.assertEqual(data['SIX DAYS']['post'], 100.0)
